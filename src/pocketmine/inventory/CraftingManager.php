...
class CraftingManager {
	...
	/**
	 * Array of cached crafting data packets for each protocol
	 *
	...
	public function buildCraftingDataCache() {
		...
		foreach([101, 105, 110, 120] as $protocol) {
			$packet = clone $pk;
	 ...
	 *
	 * @param int $protocol The protocol version the packet should be encoded for
	 *
	 * @return CraftingDataPacket
	 */
	public function getCraftingDataPacket(int $protocol) : CraftingDataPacket {
